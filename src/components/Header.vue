<template>
    <header data-aos="fade-bottom" id="header" class="header">
        <div class="container">
            <div class="header__inner">
                ...
                <div class="header__wrapper">
                    <svg class="header__mobile-bg" width="390" height="324" viewBox="0 0 390 324" fill="none"
                        ...
                        <defs>
                            <clipPath id="clip0_10_3152">
                                <rect width="443" height="367" fill="white"
                                    transform="translate(390 367) rotate(180)" />
                            </clipPath>
                        </defs>
                    </svg>
                    <nav class="header__navigation navigation">
                        <ul class="navigation__list">
                            <li class="navigation__list-item">
                                <a class="navigation__list-link navigation__list-link--active" href="#recalls">
                                    Отзывы
                                </a>
                            </li>
                            <li class="navigation__list-item">
                                <a class="navigation__list-link" href="for-partners.html">
                                    Партнёрам
                                </a>
                            </li>
                            <li class="navigation__list-item">
                                <a class="navigation__list-link" href="rules.html">
                                    Правила обмена
                                </a>
                            </li>
                            <li class="navigation__list-item">
                                <a class="navigation__list-link" href="policy.html">
                                    AML/KYC
                                </a>
                            </li>
                            <li class="navigation__list-item">
                                <a class="navigation__list-link" href="about.html">
                                    О сервесе
                                </a>
                            </li>
                        </ul>
                    </nav>
                    <div :class="langMenu.langMenuClass">
                        <button @click="langMenuToAct" class="header-user-nav__btn header-user-nav-btn" type="button">
                            <img class="header-user-nav-btn__img" src="../images/lang-flag.png" alt="flag">
                            <img class="header-user-nav-btn__arrow" src="../images/lang-arrow.png" alt="arrow">
                            <ul style="display: none;" class="header-user-nav-btn__list">
                                <li class="header-user-nav-btn__list-item">
                                    <p class="header-user-nav-btn__list-text">
                                        Ru
                                    </p>
                                </li>
                                <li class="header-user-nav-btn__list-item">
                ...
                <button class="header__btn">
                    <img class="header__btn-img" src="../images/menu-icon.png" alt="burger">
                    <img class="header__btn-img" src="../images/menu-close-icon.png" alt="burger-close">
                </button>
            </div>
        </div>
    </header>
...
export default {
    ...
    data() {
        return {
            langMenu: {
                langMenuAct: false,
                langMenuClass: 'header__user-nav header-user-nav'
            },
            // menu: {
            //     menuAct: false,
            //     bodyClass: 'body',
    ...
    methods: {
        langMenuToAct() {
            if( this.langMenu.langMenuAct == false ) {
                this.langMenu.langMenuClass += ' header-user-nav--active'
                this.langMenu.langMenuAct = true
            } else {
                this.langMenu.langMenuClass = 'header__user-nav header-user-nav'
                this.langMenu.langMenuAct = false
            }
        },
        // menuToAct() {
